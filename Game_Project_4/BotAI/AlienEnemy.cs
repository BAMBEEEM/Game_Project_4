...
/*            if (keyboardState.IsKeyDown(Keys.X))
            ...
            *//*                _charging = true;
            ...
            if (_animationFrame >= 19 && _animationFrame <= 29)
                Damaging = true;
            else
                Damaging = false;
...
/*                }
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            if (!Dead)
            {
                if (_animationTimer > _animationSpeed)
                {
                    ...
                    if (_charging)
                    {
                        ...
                        if (_animationFrame < 12 || _animationFrame > 15)
                            _animationFrame = 12;
                    }
                    ...
                    if (_attacking)
                    {
                        ...
                        if (_animationFrame < 16 || _animationFrame > 29)
                            _animationFrame = 16;
                    }
                    ...
                    {
                        if (_animationFrame < 30 || _animationFrame > 34)
                            _animationFrame = 30;
                    }
                    ...
                    if (_allAnimations)
                    {
                        if (_animationFrame < 35 || _animationFrame > 44)
                            _animationFrame = 35;
                    }
            ...
            else // stop at animation frame #3 when dead (looks the best) or stay standing if wasn't moving
            {
                ...
                {
                    if (_animationFrame == 45)
                        ; //do nothing

                    else if (_animationFrame < 35 || _animationFrame > 44)
                        _animationFrame = 35;
...
/*                if (_deadTime > 3.21)
            ...
            */
            ...
            Vector2 origin = (flipped) ? new Vector2(99, 0) : new Vector2(0, 0);
            ...
            else if (_animationFrame == 19)
            {
                source = new Rectangle(0, (_animationFrame * 96), 200, 96);
                /*                _attackBounds.Width = 109;
                                _attackBounds.Height = 109
                                _attackBounds.X = Position.X;
                                _attackBounds.Y = Position.Y;
                ;*/
            }
            ...
            */
            ...
            spriteBatch.Draw(_attackTexture, Position, source, Color, 0, origin, 2.8f, spriteEffects, 0.2f);
